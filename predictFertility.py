...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 02:36:22 2019
...
def pred_fertility(country,year): 
    df_fr = pd.read_csv('Backend/Datasets/CO2.csv', error_bad_lines=False, skiprows=4)
    df_fr = df_fr.drop(['Country Code','Indicator Name','Indicator Code','2018','2019','Unnamed: 64'], axis=1)
    ...
    plt.title("Fertility Rate for " + country)
    plt.savefig("predicted_images/FertilityRate.png")
    plt.close()
